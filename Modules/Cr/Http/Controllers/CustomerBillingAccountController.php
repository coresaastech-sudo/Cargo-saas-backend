...
use Modules\Cr\Entities\CrCustomerBillingAccount;
use Modules\Cr\Entities\Views\VwCrCustomerBillingAccount;
use Throwable;

class CustomerBillingAccountController extends Controller
{
    protected $model = CrCustomerBillingAccount::class;

    protected $view = VwCrCustomerBillingAccount::class;

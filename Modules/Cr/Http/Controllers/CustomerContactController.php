...
use Modules\Cr\Entities\CrCustomerContact;
use Modules\Cr\Entities\Views\VwCrCustomerContact;
use Throwable;

class CustomerContactController extends Controller
{
    protected $model = CrCustomerContact::class;

    protected $view = VwCrCustomerContact::class;

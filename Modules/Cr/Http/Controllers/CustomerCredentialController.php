...
use Modules\Cr\Entities\CrCustomerCredential;
use Modules\Cr\Entities\Views\VwCrCustomerCredential;
use Throwable;

class CustomerCredentialController extends Controller
{
    protected $model = CrCustomerCredential::class;

    protected $view = VwCrCustomerCredential::class;

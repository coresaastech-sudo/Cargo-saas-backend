...
use Modules\Cr\Entities\CrCustomerStakeholder;
use Modules\Cr\Entities\Views\VwCrCustomerStakeholder;
use Throwable;

class CustomerStakeholderController extends Controller
{
    protected $model = CrCustomerStakeholder::class;

    protected $view = VwCrCustomerStakeholder::class;

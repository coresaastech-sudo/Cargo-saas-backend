...
use Modules\Cr\Entities\CrCustomerBatche;
use Modules\Cr\Entities\Views\VwCrCustomerBatche;
use Throwable;

class CustomerBatchController extends Controller
{
    protected $model = CrCustomerBatche::class;

    protected $view = VwCrCustomerBatche::class;

...
use Modules\Cr\Entities\CrCustomerDeliveryPreference;
use Modules\Cr\Entities\Views\VwCrCustomerDeliveryPreference;
use Throwable;

class CustomerDeliveryPreferenceController extends Controller
{
    protected $model = CrCustomerDeliveryPreference::class;

    protected $view = VwCrCustomerDeliveryPreference::class;

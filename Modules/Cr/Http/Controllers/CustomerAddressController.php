...
use Modules\Cr\Entities\CrCustomerAddress;
use Modules\Cr\Entities\Views\VwCrCustomerAddress;
use Throwable;

class CustomerAddressController extends Controller
{
    protected $model = CrCustomerAddress::class;

    protected $view = VwCrCustomerAddress::class;

...
use Modules\Cr\Entities\CrCustomerMessage;
use Modules\Cr\Entities\Views\VwCrCustomerMessage;
use Throwable;

class CustomerMessageController extends Controller
{
    protected $model = CrCustomerMessage::class;

    protected $view = VwCrCustomerMessage::class;

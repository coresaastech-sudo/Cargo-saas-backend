...
use Modules\Cr\Entities\CrCustomerRelationship;
use Modules\Cr\Entities\Views\VwCrCustomerRelationship;
use Throwable;

class CustomerRelationshipController extends Controller
{
    protected $model = CrCustomerRelationship::class;

    protected $view = VwCrCustomerRelationship::class;

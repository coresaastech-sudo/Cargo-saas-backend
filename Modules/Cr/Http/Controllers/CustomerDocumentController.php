...
use Modules\Cr\Entities\CrCustomerDocument;
use Modules\Cr\Entities\Views\VwCrCustomerDocument;
use Throwable;

class CustomerDocumentController extends Controller
{
    protected $model = CrCustomerDocument::class;

    protected $view = VwCrCustomerDocument::class;

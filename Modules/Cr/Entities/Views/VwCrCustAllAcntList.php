...
use Modules\Gp\Enums\DeAcntStatusCodeEnum;
use Modules\Gp\Enums\LnStatusCodeEnum;
use Illuminate\Support\Str;

class VwCrCustAllAcntList extends Model
{
    use HasFactory;
    /**
     ...
     */
    protected $table = 'vw_cr_cust_all_acnt';
    protected $fillable = [
        'custid',
        'id1',
        'custno',
    ...
    public function getStatusnameAttribute()
    {
        ...
        } else if (Str::upper($this->acntmode) == 'DE') {
            return __('messages.' . DeAcntStatusCodeEnum::toString($this->statusid));
        } else {

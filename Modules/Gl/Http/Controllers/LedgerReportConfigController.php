...
use Modules\Gl\Entities\GlReportConfig;
use Modules\Gl\Entities\Views\VwGlReportConfig;
use Throwable;

class LedgerReportConfigController extends Controller
{
    protected $model = GlReportConfig::class;

    protected $view = VwGlReportConfig::class;

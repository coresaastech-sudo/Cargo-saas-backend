...
use Modules\Gl\Entities\GlAccountGroup;
use Modules\Gl\Entities\Views\VwGlAccountGroup;
use Throwable;

class LedgerAccountGroupController extends Controller
{
    protected $model = GlAccountGroup::class;

    protected $view = VwGlAccountGroup::class;

...
use Modules\Gl\Entities\GlPostingRule;
use Modules\Gl\Entities\Views\VwGlPostingRule;
use Throwable;

class LedgerPostingRuleController extends Controller
{
    protected $model = GlPostingRule::class;

    protected $view = VwGlPostingRule::class;

...
use Modules\Gl\Entities\GlReportRun;
use Modules\Gl\Entities\Views\VwGlReportRun;
use Throwable;

class LedgerReportRunController extends Controller
{
    protected $model = GlReportRun::class;

    protected $view = VwGlReportRun::class;

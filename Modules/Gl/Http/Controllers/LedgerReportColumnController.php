...
use Modules\Gl\Entities\GlReportColumn;
use Modules\Gl\Entities\Views\VwGlReportColumn;
use Throwable;

class LedgerReportColumnController extends Controller
{
    protected $model = GlReportColumn::class;

    protected $view = VwGlReportColumn::class;
    ...
    protected $organizationScoped = false;

...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('GP_ACTION_CODE', function (Blueprint $table) {
            ...
            $table->smallInteger('txntype')->default(9)->comment('Гүйлгээний төрөл 9 - санхүүгийн бус гүйлгээ 5 - хоёрдмол 2 - санхүүгийн гүйлгээ, 3 - Supervisor-тай бүртгэл');
            // $table->string('blroleid', 100)->nullable();
            ...
            $table->primary(['ACTION_CODE', 'statusid']);
        });
    }
    ...
    {
        Schema::dropIfExists('GP_ACTION_CODE');
    }
};

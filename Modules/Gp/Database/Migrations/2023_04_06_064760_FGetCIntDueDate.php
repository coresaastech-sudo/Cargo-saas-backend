...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::statement("CREATE OR REPLACE FUNCTION GETCINTDUEDATE (
            pacntno VARCHAR,
            pdue NUMERIC,
            pnow DATE,
            pinstid NUMERIC
        ...
        BEGIN
                    ...
                    from (
                        ...
                        SELECT txndate, SUM(txnamount) AS txnamount
                            ...
                            WHERE CORR = 0
                                AND acntno = pacntno
                                AND txndate <= pnow
                                AND txncode IN ('ln902052', 'ln902055')
            ...
            RETURN (DATE_TRUNC('day', vprevtrandate));
        END;
        $$ LANGUAGE plpgsql;");
    }
    ...
    {
        DB::statement("DROP FUNCTION GETCINTDUEDATE");
    }
};

...
use Modules\Gp\Entities\GpUserDelegate;
use Modules\Gp\Entities\Views\VwGpUserDelegate;
use Throwable;

class UserDelegateController extends Controller
{
    protected $model = GpUserDelegate::class;

    protected $view = VwGpUserDelegate::class;

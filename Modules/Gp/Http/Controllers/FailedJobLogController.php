...
use Modules\Gp\Entities\GpFailedJobLog;
use Modules\Gp\Entities\Views\VwGpFailedJobLog;
use Throwable;

class FailedJobLogController extends Controller
{
    protected $model = GpFailedJobLog::class;

    protected $view = VwGpFailedJobLog::class;

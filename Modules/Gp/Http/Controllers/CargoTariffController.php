...
use Modules\Gp\Entities\GpServiceTariff;
use Modules\Gp\Entities\Views\VwGpServiceTariff;
use Throwable;

class CargoTariffController extends Controller
{
    protected $model = GpServiceTariff::class;

    protected $view = VwGpServiceTariff::class;

...
use Modules\Gp\Entities\GpWhitelabelConfig;
use Modules\Gp\Entities\Views\VwGpWhitelabelConfig;
use Throwable;

class WhiteLabelController extends Controller
{
    protected $model = GpWhitelabelConfig::class;

    protected $view = VwGpWhitelabelConfig::class;

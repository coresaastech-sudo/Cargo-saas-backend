...
use Modules\Gp\Entities\GpProviderConfig;
use Modules\Gp\Entities\Views\VwGpProviderConfig;
use Throwable;

class ProviderConfigController extends Controller
{
    protected $model = GpProviderConfig::class;

    protected $view = VwGpProviderConfig::class;

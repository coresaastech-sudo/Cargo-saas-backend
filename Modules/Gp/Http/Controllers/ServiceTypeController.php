...
use Modules\Gp\Entities\GpServiceType;
use Modules\Gp\Entities\Views\VwGpServiceType;
use Throwable;

class ServiceTypeController extends Controller
{
    protected $model = GpServiceType::class;

    protected $view = VwGpServiceType::class;

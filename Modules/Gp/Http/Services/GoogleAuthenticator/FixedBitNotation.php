    ...
    public function decode($encodedString, $caseSensitive = true, $strict = false): string
    {
        ...
        for ($c = 0; $c <= $lastNotatedIndex; ++$c) {
            if (!isset($charmap[$encodedString[$c]]) && !$caseSensitive) {
                ...
                if (isset($charmap[$cUpper = mb_strtoupper($encodedString[$c])])) {
...
class_alias('Modules\Gp\Http\Services\GoogleAuthenticator\FixedBitNotation', 'Google\Authenticator\FixedBitNotation', false);

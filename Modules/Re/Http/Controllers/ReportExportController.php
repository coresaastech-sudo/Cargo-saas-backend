...
use Modules\Re\Entities\ReReportExport;
use Modules\Re\Entities\Views\VwReReportExport;
use Throwable;

class ReportExportController extends Controller
{
    protected $model = ReReportExport::class;

    protected $view = VwReReportExport::class;

...
use Modules\Re\Entities\ReReportRunLog;
use Modules\Re\Entities\Views\VwReReportRunLog;
use Throwable;

class ReportRunLogController extends Controller
{
    protected $model = ReReportRunLog::class;

    protected $view = VwReReportRunLog::class;

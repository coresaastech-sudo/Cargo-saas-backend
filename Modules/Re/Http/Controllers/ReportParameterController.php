...
use Modules\Re\Entities\ReReportParameter;
use Modules\Re\Entities\Views\VwReReportParameter;
use Throwable;

class ReportParameterController extends Controller
{
    protected $model = ReReportParameter::class;

    protected $view = VwReReportParameter::class;

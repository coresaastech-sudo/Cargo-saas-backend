...
use Modules\Re\Entities\ReDatasetField;
use Modules\Re\Entities\Views\VwReDatasetField;
use Throwable;

class ReportFieldController extends Controller
{
    protected $model = ReDatasetField::class;

    protected $view = VwReDatasetField::class;

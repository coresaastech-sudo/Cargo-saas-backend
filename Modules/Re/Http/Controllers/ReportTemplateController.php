...
use Modules\Re\Entities\ReReportTemplate;
use Modules\Re\Entities\Views\VwReReportTemplate;
use Throwable;

class ReportTemplateController extends Controller
{
    protected $model = ReReportTemplate::class;

    protected $view = VwReReportTemplate::class;

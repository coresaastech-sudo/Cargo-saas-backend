...
use Modules\Re\Entities\ReReportParameterOption;
use Modules\Re\Entities\Views\VwReReportParameterOption;
use Throwable;

class ReportParameterOptionController extends Controller
{
    protected $model = ReReportParameterOption::class;

    protected $view = VwReReportParameterOption::class;

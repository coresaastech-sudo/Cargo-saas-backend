...
use Modules\Re\Entities\ReDataset;
use Modules\Re\Entities\Views\VwReDataset;
use Throwable;

class ReportDatasetController extends Controller
{
    protected $model = ReDataset::class;

    protected $view = VwReDataset::class;

...
use Modules\Re\Entities\ReReportDimension;
use Modules\Re\Entities\Views\VwReReportDimension;
use Throwable;

class ReportDimensionController extends Controller
{
    protected $model = ReReportDimension::class;

    protected $view = VwReReportDimension::class;

...
use Modules\Re\Entities\ReReportContent;
use Modules\Re\Entities\Views\VwReReportContent;
use Throwable;

class ReportContentController extends Controller
{
    protected $model = ReReportContent::class;

    protected $view = VwReReportContent::class;

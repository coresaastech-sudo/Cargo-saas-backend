...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Schema::table('ad_notifications', function (Blueprint $table) {
            ...
            $table->smallInteger('is_all_cust')->default(0)->comment('Бүх харилцагчид мэдэгдэл илгээгдсэн эсэх 1-тийм, 0-үгүй');
            $table->smallInteger('is_all_emp')->default(0)->comment('Бүх ажилчдад мэдэгдэл илгээгдсэн эсэх 1-тийм, 0-үгүй');
        });
    ...
    {
        Schema::table('ad_notifications', function (Blueprint $table) {
            $table->dropColumn(['is_all_cust', 'is_all_emp']);

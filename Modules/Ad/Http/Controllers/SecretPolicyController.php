...
use Modules\Ad\Entities\AdSecretPolicy;
use Modules\Ad\Entities\Views\VwAdSecretPolicy;
use Throwable;

class SecretPolicyController extends Controller
{
    protected $model = AdSecretPolicy::class;

    protected $view = VwAdSecretPolicy::class;

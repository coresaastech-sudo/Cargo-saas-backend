...
use Modules\Ad\Entities\AdNotificationTemplate;
use Modules\Ad\Entities\Views\VwAdNotificationTemplate;
use Throwable;

class NotificationTemplateController extends Controller
{
    protected $model = AdNotificationTemplate::class;

    protected $view = VwAdNotificationTemplate::class;

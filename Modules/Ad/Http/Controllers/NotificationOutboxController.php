...
use Modules\Ad\Entities\AdNotification;
use Modules\Ad\Entities\Views\VwAdNotification;
use Throwable;

class NotificationOutboxController extends Controller
{
    protected $model = AdNotification::class;

    protected $view = VwAdNotification::class;

...
use Modules\Ad\Entities\AdAutomationRun;
use Modules\Ad\Entities\Views\VwAdAutomationRun;
use Throwable;

class AutomationRunController extends Controller
{
    protected $model = AdAutomationRun::class;

    protected $view = VwAdAutomationRun::class;

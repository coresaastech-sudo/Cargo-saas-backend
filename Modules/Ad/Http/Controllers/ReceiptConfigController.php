...
use Modules\Ad\Entities\AdReceiptConfig;
use Modules\Ad\Entities\Views\VwAdReceiptConfig;
use Throwable;

class ReceiptConfigController extends Controller
{
    protected $model = AdReceiptConfig::class;

    protected $view = VwAdReceiptConfig::class;

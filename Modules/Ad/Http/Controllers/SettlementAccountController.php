...
use Modules\Ad\Entities\AdSettlementAccount;
use Modules\Ad\Entities\Views\VwAdSettlementAccount;
use Throwable;

class SettlementAccountController extends Controller
{
    protected $model = AdSettlementAccount::class;

    protected $view = VwAdSettlementAccount::class;

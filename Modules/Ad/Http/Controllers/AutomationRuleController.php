...
use Modules\Ad\Entities\AdAutomationRule;
use Modules\Ad\Entities\Views\VwAdAutomationRule;
use Throwable;

class AutomationRuleController extends Controller
{
    protected $model = AdAutomationRule::class;

    protected $view = VwAdAutomationRule::class;

...
use Modules\Ad\Entities\AdReportPermission;
use Modules\Ad\Entities\Views\VwAdReportPermission;
use Throwable;

class ReportPermissionController extends Controller
{
    protected $model = AdReportPermission::class;

    protected $view = VwAdReportPermission::class;

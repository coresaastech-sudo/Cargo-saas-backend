                        ...
                        <td>
                            <table style="width:100%;background-color:white;margin:0;padding:50px;border-radius:10px"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="3" style="color:#04c40e;font-size:14px;padding:10px 0">
                                            <img src="https://www.freeiconspng.com/thumbs/check-mark-png/check-mark-icon-green-0.png" width="20">

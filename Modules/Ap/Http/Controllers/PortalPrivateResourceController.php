...
use Modules\Ap\Entities\ApPrivateResource;
use Modules\Ap\Entities\Views\VwApPrivateResource;
use Throwable;

class PortalPrivateResourceController extends Controller
{
    protected $model = ApPrivateResource::class;

    protected $view = VwApPrivateResource::class;

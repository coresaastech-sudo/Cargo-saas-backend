...
use Modules\Ap\Entities\ApAccessToken;
use Modules\Ap\Entities\Views\VwApAccessToken;
use Throwable;

class PortalAccessTokenController extends Controller
{
    protected $model = ApAccessToken::class;

    protected $view = VwApAccessToken::class;

...
use Modules\Ap\Entities\ApCustomerContract;
use Modules\Ap\Entities\Views\VwApCustomerContract;
use Throwable;

class PortalContractController extends Controller
{
    protected $model = ApCustomerContract::class;

    protected $view = VwApCustomerContract::class;

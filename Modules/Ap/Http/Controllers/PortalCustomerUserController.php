...
use Modules\Ap\Entities\ApCustomerUser;
use Modules\Ap\Entities\Views\VwApCustomerUser;
use Throwable;

class PortalCustomerUserController extends Controller
{
    protected $model = ApCustomerUser::class;

    protected $view = VwApCustomerUser::class;

...
use Modules\Ap\Entities\ApStopService;
use Modules\Ap\Entities\Views\VwApStopService;
use Throwable;

class PortalStopServiceController extends Controller
{
    protected $model = ApStopService::class;

    protected $view = VwApStopService::class;

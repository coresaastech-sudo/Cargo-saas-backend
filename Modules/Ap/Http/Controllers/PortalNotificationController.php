...
use Modules\Ap\Entities\ApNotification;
use Modules\Ap\Entities\Views\VwApNotification;
use Throwable;

class PortalNotificationController extends Controller
{
    protected $model = ApNotification::class;

    protected $view = VwApNotification::class;
